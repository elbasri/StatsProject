...
function Cover() {
  ...
  const onDrop = async (acceptedFiles) => {
    ...
    try {
      const response = await axios.post('https://statsprojectapi.maktab.ma/api/uploaded-files/', formData);
  ...
  const handleApplyAlgorithm = () => {
    ...
    axios
      .post('https://statsprojectapi.maktab.ma/api/apply-algorithm/', requestData)
      .then((response) => {
